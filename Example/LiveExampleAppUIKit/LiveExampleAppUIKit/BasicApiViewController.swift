...
class BasicApiViewController: UIViewController {
	...
	override func viewDidLoad() {
		...
		let textAttributes = [NSAttributedString.Key.foregroundColor: BasicApiViewController.pbjLivePink]
	...
	func buttonTapped() {
		...
		if let id = showTextField.text, !id.isEmpty {
			showId = id
		}
...
extension BasicApiViewController: LivePlayerViewControllerDelegate {
...
extension BasicApiViewController: UITextFieldDelegate {
	func textFieldShouldReturn(_ textField: UITextField) -> Bool {
		textField.resignFirstResponder()
	}
}

extension BasicApiViewController: UIPickerViewDataSource {
...
extension BasicApiViewController: UIPickerViewDelegate {
